...
# $ clang-tidy --dump-config --checks=*,-llvm-header-guard,-fuchsia-trailing-return,-fuchsia-statically-constructed-objects,-fuchsia-default-arguments-calls,-fuchsia-overloaded-operator,-cert-err58-cpp,-cppcoreguidelines-macro-usage,-google-runtime-references -- --std=c++14 > .clang-tidy
...
clang-tidy "$1" -config='' -header-filter=.* --quiet -- -std=c++14 -I. -isystem TMCompiler/utils/vendor
