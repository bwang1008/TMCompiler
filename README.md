...
The current project version is version 0.0.0.
...
- multiple files
- the operators `++`, `--`, `<<`, `>>`, `<<=`, `>>=`, `~`, `&`, `|`, or the ternary conditional operator
- casting
